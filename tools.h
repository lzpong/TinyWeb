...
_INLINE uint membuf_append_byte(membuf_t* buf, uchar b) {
	return membuf_append_data(buf, &b, sizeof(b));
}
_INLINE uint membuf_append_int(membuf_t* buf, int i) {
	return membuf_append_data(buf, &i, sizeof(i));
}
_INLINE uint membuf_append_uint(membuf_t* buf, uint ui) {
	return membuf_append_data(buf, &ui, sizeof(ui));
}
_INLINE uint membuf_append_long(membuf_t* buf, long i) {
	return membuf_append_data(buf, &i, sizeof(i));
}
_INLINE uint membuf_append_ulong(membuf_t* buf, ulong ui) {
	return membuf_append_data(buf, &ui, sizeof(ui));
}
_INLINE uint membuf_append_short(membuf_t* buf, short s) {
	return membuf_append_data(buf, &s, sizeof(s));
}
_INLINE uint membuf_append_ushort(membuf_t* buf, ushort us) {
	return membuf_append_data(buf, &us, sizeof(us));
}
_INLINE uint membuf_append_float(membuf_t* buf, float f) {
	return membuf_append_data(buf, &f, sizeof(f));
}
_INLINE uint membuf_append_double(membuf_t* buf, double d) {
	return membuf_append_data(buf, &d, sizeof(d));
}
_INLINE uint membuf_append_ptr(membuf_t* buf, void* ptr) {
